...
const zs = "_wrapper_1dgs7_1",
      ...
      h = () => {
        ...
        (n[t] && (g > 4e3 ? u(o[1]) : u(o[0])),
          ...
          (d.current = setTimeout(() => {
            var m, y;
            ((m = l.current) == null || m.setFrame(0),
              (y = l.current) == null || y.play());
          }, g)));
      };
    return (
      B.useEffect(() => {
      ...
      B.useEffect(() => {
        ...
        if (!c) {
          if (!s) {
            ((g = l.current) == null || g.setFrame(0),
              (m = l.current) == null || m.pause());
            return;
          }
          return (
            setTimeout(() => {
            ...
            () => {
              ...
              (d.current && (clearTimeout(d.current), (d.current = null)),
                (x = l.current) == null ||
                  x.removeEventListener("complete", h));
            }
          );
        }
      }, [s, c]),
  ...
  Ks = ({ className: o, ...t }) =>
    k.jsx($e, {
      lottieSources: [
        "/lottie/Bird_Orange_01.lottie",
        "/lottie/Bird_Orange_02.lottie",
        "/lottie/Bird_Orange_03.lottie",
      ],
      birdKey: "orange",
      width: 261,
      height: 261,
  ...
  Js = ({ className: o, ...t }) =>
    k.jsx($e, {
      lottieSources: [
        "/lottie/Bird_Green_01.lottie",
        "/lottie/Bird_Green_02.lottie",
        "/lottie/Bird_Green_03.lottie",
      ],
      birdKey: "green",
      width: 248,
      height: 248,
  ...
  io = ({ className: o, ...t }) =>
    k.jsx($e, {
      lottieSources: [
        "/lottie/Bird_Blue_01.lottie",
        "/lottie/Bird_Blue_02.lottie",
        "/lottie/Bird_Blue_03.lottie",
      ],
      width: 261,
      height: 261,
      birdKey: "blue",
  ...
  so = ({ className: o, ...t }) =>
    k.jsx($e, {
      lottieSources: [
        "/lottie/Bird_Red_01.lottie",
        "/lottie/Bird_Red_02.lottie",
        "/lottie/Bird_Red_03.lottie",
      ],
      birdKey: "red",
      width: 261,
      height: 261,
  ...
  lo = ({ className: o, ...t }) =>
    k.jsx($e, {
      lottieSources: [
        "/lottie/Bird_Yellow_01.lottie",
        "/lottie/Bird_Yellow_02.lottie",
        "/lottie/Bird_Yellow_03.lottie",
      ],
      birdKey: "yellow",
      width: 194,
      height: 217,
 ...
 */ var ht = {
  ...
  ur = function (t) {
    ...
    for (r = t.length; r--;)
      (t[r] && (t[r]._gsap || (t[r]._gsap = new $n(t[r], i)))) ||
        t.splice(r, 1);
    return t;
  },
  Zt = function (t) {
  ...
  yn = function (t, e, i) {
    return (i = t[e]) && V(i)
      ? t[e]()
      : (rr(i) && t.getAttribute && t.getAttribute(e)) || i;
  },
  nt = function (t, e) {
  ...
  xn = function (t, e, i, r) {
    (Ft.length && !G && ei(),
      t.render(e, i, !!(G && e < 0 && fr(t))),
      Ft.length && !G && ei());
  },
  vn = function (t) {
    var e = parseFloat(t);
    return (e || e === 0) && (t + "").match(_n).length < 2
      ? e
      : W(t)
        ? t.trim()
        : t;
  ...
  bn = function (t, e) {
    ...
    if (
      ((e._time ||
        ...
        ((i = ri(t.rawTime(), e)),
        (!e._dur || Ye(0, e.totalDuration(), i) - e._tTime > Z) &&
          e.render(i, !0)),
  ...
  kt = function (t, e, i, r) {
    return (
      e.parent && Vt(e),
      (e._start = q(
        (Lt(i) ? i : i || t !== F ? mt(t, i, e) : t._time) + e._delay,
      )),
      (e._end = q(
  ...
  Sn = function (t, e) {
    return (
      (_t.ScrollTrigger || or("scrollTrigger", e)) &&
      _t.ScrollTrigger.create(e, t)
    );
  },
  Pn = function (t, e, i, r, n) {
    ...
    if (
      ...
      return (Ft.push(t), (t._lazy = [n, r]), 1);
  },
  Mo = function o(t) {
    var e = t.parent;
    ...
    if (
      ...
      (e < 0 && Di(t, e, i, !0),
        ...
        (e >= t._tDur || e < 0) &&
          ...
          !i &&
            !G &&
            (ct(t, s ? "onComplete" : "onReverseComplete", !0),
            t._prom && t._prom())));
  ...
  Re = function (t, e, i) {
    ...
    if ((r && (s.duration = e[1]), (s.parent = i), t)) {
      for (a = s, u = i; u && !("immediateRender" in a);)
        ((a = u.vars.defaults || {}), (u = rt(u.vars.inherit) && u.parent));
      ((s.immediateRender = rt(a.immediateRender)),
  ...
  xt = function (t, e, i) {
    return j && !e && j.selector
      ? j.selector(t)
      : W(t) && !i && (Ai || !ye())
        ? Ii.call((e || sr).querySelectorAll(t), 0)
        : Q(t)
          ? Eo(t, i)
          : kn(t)
            ? Ii.call(t, 0)
      ...
      function (e) {
        ...
        return xt(
          ...
          i.querySelectorAll
            ? i
            : i === t
              ? Ee("Invalid scope") || sr.createElement("div")
              : t,
        );
      }
    );
  ...
  Rn = function (t) {
    ...
    return (
      W(r)
        ? (f = c = { center: 0.5, edges: 0.5, end: 1 }[r] || 0)
        : !a && u && ((f = r[0]), (c = r[1])),
      function (_, d, p) {
        var h = (p || e).length,
          g = s[h],
        ...
        if (!g) {
          if (((w = e.grid === "auto" ? 0 : (e.grid || [1, Rt])[1]), !w)) {
            for (
              S = -1e8;
              S < (S = p[w++].getBoundingClientRect().left) && w < h;
            );
            w < h && w--;
          }
          for (
            g = s[h] = [],
              m = u ? Math.min(w, h) * f - 0.5 : r % w,
              y = w === Rt ? 0 : u ? (h * c) / w - 0.5 : (r / w) | 0,
              S = 0,
              P = Rt,
              b = 0;
            b < h;
            ...
            ((x = (b % w) - m),
              (T = y - ((b / w) | 0)),
              (g[b] = v = l ? Math.abs(l === "y" ? T : x) : un(x * x + T * T)),
              v > S && (S = v),
              v < P && (P = v));
          (r === "random" && Mn(g),
            (g.max = S - P),
  ...
  Le = function (t) {
    for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e));)
      ((s = t.indexOf(")", r)),
        ...
        (i +=
          t.substr(e, r - e) + On(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
        (e = s + 1));
      ...
      if ((t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), Se[t]))
        ...
        if (
          ...
          return (
            ...
            [r >> 16, (r >> 8) & N, r & N, parseInt(t.substr(7), 16) / 255]
          );
        ...
        if (((r = p = t.match(Ei)), !e))
          ...
          return ((r = t.match(cn)), i && r.length < 4 && (r[3] = 1), r);
  ...
  Cr = function (t, e, i) {
    ...
    if (
      ...
      for (l = t.replace($t, "1").split(ae), c = l.length - 1; a < c; a++)
        r +=
          l[a] +
          (~u.indexOf(a)
            ? n.shift() || s + "0,0,0,0)"
    ...
    if (!l)
      for (l = t.split($t), c = l.length - 1; a < c; a++) r += l[a] + n[a];
    return r + l[c];
  },
  $t = (function () {
    var o =
  ...
  Yo = function (t) {
    for (
      ...
      ((u = i[n]),
        ...
        (l = u.substr(0, a)),
        (e[r] = isNaN(l) ? l.replace($o, "").trim() : +l),
        (r = u.substr(a + 1).trim()));
    return e;
  },
  Vo = function (t) {
  ...
  Uo = function (t) {
    ...
    return i && e.length > 1 && i.config
      ? i.config.apply(
          null,
          ~t.indexOf("{") ? [Yo(e[1])] : Vo(t).split(",").map(vn),
        )
      : E._CE && Fo.test(t)
        ? E._CE("", t)
        : i;
  ...
  Ne = (function () {
    ...
    return (
      ...
      (t.time = function (i, r) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), i + kr(this)) %
      ...
      (t.timeScale = function (i, r) {
        ...
        var n =
          this.parent && this._ts ? ri(this.parent._time, this) : this._tTime;
        return (
          (this._rts = +i || 0),
          (this._ts = this._ps || i === -1e-8 ? 0 : this._rts),
          this.totalTime(
            Ye(-Math.abs(this._delay), this.totalDuration(), n),
            r !== !1,
          ),
          di(this),
          Po(this)
      ...
      (t.startTime = function (i) {
        if (arguments.length) {
          ...
          return (
            r && (r._sort || !this.parent) && kt(r, this, i - this._delay),
            this
          );
        }
        return this._start;
      ...
      (t.repeat = function (i) {
        return arguments.length
          ? ((this._repeat = i === 1 / 0 ? -2 : i), Mr(this))
          : this._repeat === -2
            ? 1 / 0
            : this._repeat;
      }),
      ...
      (t.restart = function (i, r) {
        return (
          this.play().totalTime(i ? -this._delay : 0, rt(r)),
  ...
  return (
    ...
    (e.set = function (r, n, s) {
      return (
        (n.duration = 0),
        (n.parent = this),
        Me(n).repeatDelay || (n.repeat = 0),
        (n.immediateRender = !!n.immediateRender),
        new X(r, n, mt(this, s), 1),
        this
      );
    }),
    ...
    (e.staggerFrom = function (r, n, s, a, u, l, f) {
      return (
        (s.runBackwards = 1),
        (Me(s).immediateRender = rt(s.immediateRender)),
        this.staggerTo(r, n, s, a, u, l, f)
      );
    }),
    (e.staggerFromTo = function (r, n, s, a, u, l, f, c) {
      return (
        (a.startAt = s),
        (Me(a).immediateRender = rt(a.immediateRender)),
        this.staggerTo(r, n, a, u, l, f, c)
      );
    }),
    (e.render = function (r, n, s) {
      var a = this._time,
        ...
        S;
      if (
        (this !== F && f > u && r >= 0 && (f = u), f !== this._tTime || s || c)
      ) {
        if (
          (a !== this._time &&
            l &&
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((y = Co(this, q(a), q(_))), y && (f -= _ - (_ = y._start))),
          (this._tTime = f),
          (this._time = _),
          (this._act = !x),
          this._initted ||
        ...
        if (_ >= a && r >= 0)
          for (d = this._first; d;) {
            if (
              ((p = d._next), (d._act || _ >= d._start) && d._ts && y !== d)
            ) {
        ...
        if (
          ...
          !n &&
          (this.pause(),
          (y.render(_ >= a ? 0 : -1e-8)._zTime = _ >= a ? 1 : -1),
          this._ts)
        )
          return ((this._start = T), di(this), this.render(r, n, s));
          ...
          dt(
            {
              ...
              onStart: function () {
                if ((s.pause(), !d)) {
                  ...
                  (p._dur !== g && me(p, g, 0, 1).render(p._time, !0, !0),
                    (d = 1));
                }
                f && f.apply(p, c || []);
              },
        ...
        for (c = s.parent; a;)
          ((l = a._prev),
            ...
            f > u && s._sort && a._ts && !s._lock
              ? ((s._lock = 1), (kt(s, a, f - a._delay, 1)._lock = 0))
              : (u = f),
            f < 0 &&
              a._ts &&
              ((n -= f),
...
var Xo = function (t, e, i, r, n, s, a) {
    ...
    if (
      ...
      return !isNaN(_ * r) && r !== ""
        ? ((p = new st(
          ...
          (this._pt = p))
        : (!c && !(e in t) && or(e, r),
          Xo.call(this, t, e, _, r, d, u || ht.stringFilter, l));
  },
  qo = function (t, e, i, r, n) {
    if (
      (V(t) && (t = Ce(t, n, e, i, r)),
      !Ct(t) || (t.style && t.nodeType) || Q(t) || fn(t))
    )
  ...
  Yn = function (t, e, i, r, n, s) {
    ...
    if (
      ...
      (a = new ut[t]()).init(
        n,
        a.rawVars ? e[t] : qo(e[t], r, n, s, i),
        i,
        r,
        s,
      ) !== !1 &&
      ((i._pt = u = new st(i._pt, n, t, 0, 1, a.render, a, 0, a.priority)),
      i !== le)
    )
    ...
    if (
      ...
      if (
        ...
        h &&
          ...
          e < 0 && f && a && !d ? h.render(-1, !0) : h.revert(f && p ? He : vo),
          (h._lazy = 0)),
        s)
      ) {
        if (
      ...
      for (
        t._pt = t._ptCache = 0, u = (p && rt(u)) || (u && !p), b = 0;
        b < g.length;
        b++
      ) {
        if (
          ...
          O &&
            ...
            ((t._pt = P =
              new st(t._pt, w, C.name, 0, 1, C.render, C, 0, C.priority)),
          ...
          for (S in v)
            ut[S] && (C = Yn(S, v, t, L, w, y))
              ? C.priority && (M = 1)
              : (I[S] = P =
                  cr.call(t, w, S, "get", v[S], L, y, 0, r.stringFilter));
        (t._op && t._op[b] && t.kill(w, t._op[b]),
          x &&
            t._pt &&
            ((It = t),
            F.killTweensOf(w, I, t.globalTime(e)),
            (z = !t.parent),
            (It = 0)),
          t._pt && u && (Li[R.id] = 1));
      }
      ...
      for (
        ...
        if (!f)
          return (
            ...
            hr(t, a),
            (Fi = 0),
            u ? Ee(e + " not eligible for reset") : 1
          );
        l.push(f);
      }
    for (d = l.length; d--;)
  ...
  function t(i, r, n, s) {
    ...
    if (
      ...
      if (
        ...
        if (((S = x.length), (M = _ && Rn(_)), Ct(_)))
          for (P in _) ~Vn.indexOf(P) && (R || (R = {}), (R[P] = _[P]));
        for (v = 0; v < S; v++)
          ((b = ii(r, Un)),
            (b.stagger = 0),
            m && (b.yoyoEase = m),
        ...
        (Me(dt(T.vars.defaults, { ease: "none" })),
          (T._ease = Jt(p.ease || r.ease || "none")));
        var O = 0,
          C,
          I,
          L;
        if (Q(p))
          ...
          b = {};
          for (P in p)
            P === "ease" || P === "easeEach" || Ho(P, p[P], b, p.easeEach);
          for (P in b)
            for (
              ...
              ((I = C[v]),
                (L = {
                  ease: I.e,
                  duration: ((I.t - (v ? C[v - 1].t : 0)) / 100) * l,
                }),
                (L[P] = I.v),
                T.to(x, L, O),
                (O += L.duration));
  ...
  return (
    (e.render = function (r, n, s) {
      ...
      if (!l) Ro(this, r, n, s);
        ...
        ((x && x.render(r < 0 ? r : x._dur * x._ease(_ / this._dur), n, s)) ||
          (this._startAt && (this._zTime = r)),
          this._onUpdate &&
            !n &&
            (f && Di(this, r, n, s), ct(this, "onUpdate")),
          this._repeat &&
            p !== g &&
            this.vars.onRepeat &&
            !n &&
          ...
          (c === this._tDur || !c) &&
            ...
            !n &&
              !(f && !a) &&
              (c || a || m) &&
              (ct(this, c === u ? "onComplete" : "onReverseComplete", !0),
    ...
    (e.kill = function (r, n) {
      if ((n === void 0 && (n = "all"), !r && (!n || n === "all")))
        return (
          ...
          this.parent
            ? be(this)
            : this.scrollTrigger && this.scrollTrigger.kill(!!G),
          this
        );
      if (this.timeline) {
        var s = this.timeline.totalDuration();
        return (
          this.timeline.killTweensOf(r, n, It && It.vars.overwrite !== !0)
            ._first || be(this),
          this.parent &&
            s !== this.timeline.totalDuration() &&
            me(this, (this._dur * this.timeline._tDur) / s, 0, 1),
          this
        );
      }
      var a = this._targets,
      ...
      for (
        ...
        if (~u.indexOf(a[m])) {
          ...
          for (h in p)
            ((g = _ && _[h]),
              g &&
                ((!("kill" in g.d) || g.d.kill(h) === !0) && _i(this, g, "_pt"),
                delete _[h]),
              d !== "all" && (d[h] = 1));
        }
  ...
  ni = {
    ...
    registerEffect: function (t) {
      ...
      ((r || "").split(",").forEach(function (a) {
        return (
          a && !ut[a] && !_t[a] && Ee(e + " effect requires " + a + " plugin.")
        );
      }),
        (xi[e] = function (a, u, l) {
 ...
 */ var Br,
  ...
  vt = function o(t, e, i) {
    ...
    return (
      r[e] ||
      r.getPropertyValue(e.replace(yr, "-$1").toLowerCase()) ||
      ...
      (e in Dt && e !== ot && (e = $),
        i.removeProperty
          ? ((r = e.substr(0, 2)),
            ...
            i.removeProperty(
              r === "--" ? e : e.replace(yr, "-$1").toLowerCase(),
            ))
          : i.removeAttribute(e));
    }
  },
  ...
  Ut = function o(t, e, i, r) {
    ...
    if (
      (s !== "px" && !_ && (n = o(t, e, i, "px")),
      (m = t.getCTM && is(t)),
      (d || s === "%") && (Dt[e] || ~e.indexOf("adius")))
    )
      return (
        (p = m ? t.getBBox()[u ? "width" : "height"] : t[f]),
        U(d ? (n / p) * c : (n / 100) * p)
      );
    if (
    ...
    if (d && (e === "height" || e === "width")) {
      ...
      ((d || s === "%") &&
        ...
        (a.position = "absolute"));
    return (
      u && d && ((g = Zt(h)), (g.time = ft.time), (g.width = h[f])),
      U(_ ? (p * n) / c : p && n ? (c / p) * n : 0)
    );
  },
  Bt = function (t, e, i, r) {
    var n;
  ...
  wa = function (t, e, i, r) {
    if (!i || i === "none") {
      ...
      s && s !== i
        ? ((e = n), (i = s))
        : e === "borderColor" && (i = vt(t, "borderTopColor"));
    }
    ...
    if (
      ...
      (r += ""),
      r.substring(0, 6) === "var(--" &&
        (r = vt(t, r.substring(4, r.indexOf(")")))),
      r === "auto" &&
        ((h = t.style[e]),
        (t.style[e] = r),
        (r = vt(t, e) || r),
        h ? (t.style[e] = h) : re(t, e)),
      (f = [i, r]),
      In(f),
      (i = f[0]),
      (r = f[1]),
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (n === "all" || n === !0) ((r.cssText = ""), (u = 1));
        ...
        for (n = n.split(","), l = n.length; --l > -1;)
          ((a = n[l]),
            Dt[a] && ((u = 1), (a = a === "transformOrigin" ? ot : $)),
            re(i, a));
      u &&
        (re(i, $),
        s &&
    ...
    return i.svg && t.getAttribute("transform")
      ...
      : (n === Ie &&
          ...
          (!s || (!t.offsetParent && !t.getBoundingClientRect().width)) &&
            ((l = 1), (a = t.nextElementSibling), ce.appendChild(t)),
          (n = zr(t)),
  ...
  Xi = function (t, e, i, r, n, s) {
    ...
    (i
      ? u !== Ie &&
        (S = d * g - p * h) &&
        ((P = T * (g / S) + v * (-h / S) + (h * y - g * m) / S),
        (w = T * (-p / S) + v * (d / S) - (d * y - p * m) / S),
        (T = P),
        (v = w))
      : ((b = es(t)),
        (T = b.x + (~x[0].indexOf("%") ? (T / 100) * b.width : T)),
        (v = b.y + (~(x[1] || x[0]).indexOf("%") ? (v / 100) * b.height : v))),
      r || (r !== !1 && a.smooth)
        ? ((m = T - l),
          (y = v - f),
          (a.xOffset = c + (m * d + y * h) - m),
          (a.yOffset = _ + (m * p + y * g) - y))
      ...
      s &&
        (zt(s, a, "xOrigin", l, T),
        zt(s, a, "yOrigin", f, v),
        zt(s, a, "xOffset", c, a.xOffset),
        zt(s, a, "yOffset", _, a.yOffset)),
  ...
  je = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        (i.uncache
          ? ((H = t.getBBox()),
            (l = i.xOrigin - H.x + "px " + (i.yOrigin - H.y) + "px"),
            (z = ""))
      ...
      S !== Ie &&
        ...
        i.svg &&
          ...
          (i.forceCSS = t.setAttribute("transform", "") || !ns(vt(t, $))),
    ...
    for (u in Dt)
      ((l = r[u]),
        ...
        l !== f &&
          ...
          ((d = K(l)),
          (p = K(f)),
          (c = d !== p ? Ut(i, u, l, p) : parseFloat(l)),
          (_ = parseFloat(f)),
          (t._pt = new st(t._pt, a, u, c, _ - c, Yi)),
          (t._pt.u = p || 0),
          t._props.push(u)));
    Fr(a, r);
  };
    ...
    for (h in e)
      if (h !== "autoRound" && ((f = e[h]), !(ut[h] && Yn(h, e, i, r, t, n)))) {
        if (
          ...
          d === "string" && ~f.indexOf("random(") && (f = Le(f)),
          p)
        )
          p(this, t, h, f, i) && (S = 1);
          ...
          if (
            ...
            h in Mt &&
              (h === "autoAlpha" &&
                (_ === 1 && Bt(t, "visibility") === "hidden" && c && (_ = 0),
            ...
            if (
              ...
              d === "string" &&
                f.substring(0, 6) === "var(--" &&
                ((f = vt(t, f.substring(4, f.indexOf(")")))),
                (c = parseFloat(f))),
              T ||
                ((v = t._gsap),
                ...
                (T = this._pt =
                  new st(this._pt, a, $, 0, 1, v.renderTransform, v, 0, -1)),
                (T.dep = 1)),
              h === "scale")
            )
              ((this._pt = new st(
                ...
                "scaleY",
                v.scaleY,
                (y ? fe(v.scaleY, y + c) : c) - v.scaleY || 0,
                Yi,
              )),
                (this._pt.u = 0),
                s.push("scaleY", h),
              ...
              (P.push(ot, 0, a[ot]),
                ...
                v.svg
                  ...
                  : ((m = parseFloat(f.split(" ")[2]) || 0),
                    m !== v.zOrigin && zt(this, v, "zOrigin", v.zOrigin, m),
                    zt(this, a, h, oi(l), oi(f))));
              continue;
            } else if (h === "svgOrigin") {
              Xi(t, f, 1, b, 0, this);
              continue;
...
var Va = function (t, e) {
    var i = document.createElementNS("http://www.w3.org/2000/svg", "path"),
      ...
      s;
    for (e = "," + e + ","; --n > -1;)
      ((s = r[n].nodeName.toLowerCase()),
        e.indexOf("," + s + ",") < 0 &&
          i.setAttributeNS(null, s, r[n].nodeValue));
    return i;
  },
  Ua = {
...
function qa(o, t) {
  ...
  return e === "path" || !o.getBBox
    ...
    : ((l = Va(o, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points")),
      ...
      t &&
        o.parentNode &&
        (o.parentNode.insertBefore(l, o), o.parentNode.removeChild(o)),
      l);
}
function fs(o, t, e) {
  var i = o[t],
...
function cs(o, t, e) {
  ...
  var i = Math.max(0, ~~(Tt(e - t) - 1e-8)),
    r = $a(o);
  if (
    (t > e && ((t = 1 - t), (e = 1 - e), za(r), (r.totalLength = 0)),
    t < 0 || e < 0)
  ) {
...
function Wa(o, t, e) {
  ...
  for (l.length = f.length = 0, h = t + 2; h < n; h += 6) {
    if (
      ...
      (S = o[h + 1] - a),
      (x = T = P = w = 0),
      Tt(g) < 0.01 && Tt(v) < 0.01 && Tt(y) + Tt(S) < 0.01)
    )
  ...
  if (l.length && c) {
    if (
      ((o.totalLength = I = l[l.length - 1] || 0),
      (o.minLength = c),
      I / c < 9999)
    )
      for (C = O = 0, p = 0; p < I; p += c) f[C++] = l[O] < p ? ++O : O;
  } else o.totalLength = l[0] = 0;
  return t ? d - l[t / 2 - 1] : d;
}
function ee(o, t) {
  var e, i, r;
  for (r = e = i = 0; r < o.length; r++)
    ((o[r].resolution = ~~t || 12), (i += o[r].length), (e += Wa(o[r])));
...
function Xr(o, t, e, i) {
  ...
  if (!t) ((_ = c = r = 0), (n = o[0]));
    ...
    ((_ = 1), (r = o.length - 1), (n = o[r]), (c = n.length - 8));
  else {
    if (o.length > 1) {
      for (u = o.totalLength * t, f = c = 0; (f += o[c++].totalLength) < u;)
        r = c;
...
function qr(o, t, e, i) {
  ...
  return (
    ...
    (u = r.totalLength * t),
    (c = r.lookup.length
      ? r.lookup[t < 1 ? ~~(u / r.minLength) : r.lookup.length - 1] || 0
      : us(s, u, t)),
    (l = c ? s[c - 1] : 0),
    (f = s[c]),
    f < u && ((l = f), (f = s[++c])),
    ...
    (n.x = D(
      (_ * _ * (r[c + 6] - d) +
        3 * p * (_ * (r[c + 4] - d) + p * (r[c + 2] - d))) *
        _ +
        d,
    )),
    (n.y = D(
      (_ * _ * (r[c + 7] - (d = r[c + 1])) +
        3 * p * (_ * (r[c + 5] - d) + p * (r[c + 3] - d))) *
        _ +
        d,
    )),
    e &&
      (n.angle = r.totalLength
        ? fs(r, c, _ >= 1 ? 1 - 1e-9 : _ || 1e-9)
        : r.angle || 0),
    n
  );
}
function Pe(o, t, e, i, r, n, s) {
  for (var a = o.length, u, l, f, c, _; --a > -1;)
    for (u = o[a], l = u.length, f = 0; f < l; f += 2)
      ((c = u[f]),
        (_ = u[f + 1]),
        (u[f] = c * t + _ * i + n),
        (u[f + 1] = c * e + _ * r + s));
...
function Ga(o, t, e, i, r, n, s, a, u) {
  if (!(o === a && t === u)) {
    ...
    var P = (n === s ? -1 : 1) * Et(S),
      ...
      J =
        (L * H - A * z < 0 ? -1 : 1) *
        Math.acos((L * z + A * H) / Et(qt * (z * z + H * H)));
    (isNaN(J) && (J = _),
      !s && J > 0 ? (J -= d) : s && J < 0 && (J += d),
      (Nt %= d),
      (J %= d));
    ...
    for (lt = 0; lt < bt; lt++)
      ((r = Nt + lt * it),
        ...
        (L = Xe((r += it))),
        (A = Ue(r)),
        pt.push(g - gt * m, m + gt * g, L + gt * A, A - gt * L, L, A));
    for (lt = 0; lt < pt.length; lt += 2)
      ((g = pt[lt]),
        (m = pt[lt + 1]),
        (pt[lt] = g * Ts + m * bs + C),
        (pt[lt + 1] = g * ws + m * Ss + I));
...
function li(o) {
  var t =
    ...
    P = function (M, R, O, C) {
      ((y = (O - M) / 3),
        (x = (C - R) / 3),
        h.push(M + y, R + x, O - y, C - x, O, C));
    };
  if (!o || !isNaN(t[0]) || isNaN(t[1])) return (console.log(u), e);
  for (l = 0; l < s; l++)
    if (
      ((v = d),
      isNaN(t[l]) ? ((d = t[l].toUpperCase()), (p = d !== t[l])) : l--,
      (c = +t[l + 1]),
      (_ = +t[l + 2]),
      p && ((c += i), (_ += r)),
      l || ((g = c), (m = _)),
      ...
      (h && (h.length < 8 ? (e.length -= 1) : (a += h.length)),
        (i = g = c),
        (r = m = _),
        (h = [c, _]),
        e.push(h),
      ...
      ((y = i),
        (x = r),
        (v === "C" || v === "S") &&
          ((y += i - h[h.length - 4]), (x += r - h[h.length - 3])),
        p || (i = r = 0),
      ...
      ((y = i + (c - i) * n),
        ...
        (i += t[l + 3] * 1),
        (r += t[l + 4] * 1),
        h.push(y, x, i + (c - i) * n, r + (_ - r) * n, i, r),
        (l += 4));
    else if (d === "T")
      ((y = i - h[h.length - 4]),
        (x = r - h[h.length - 3]),
      ...
      (d === "Z" && ((c = g), (_ = m), (h.closed = !0)),
        (d === "L" || Tt(i - c) > 0.5 || Tt(r - _) > 0.5) &&
          (P(i, r, c, _), d === "L" && (l += 2)),
        (i = c),
        (r = _));
    else if (d === "A") {
  ...
  return (
    ...
    l < 6
      ? (e.pop(), (l = 0))
      : h[0] === h[l - 2] && h[1] === h[l - 1] && (h.closed = !0),
    (e.totalPoints = a + l),
    e
  );
}
function Ha(o, t) {
  t === void 0 && (t = 1);
  for (var e = o[0], i = 0, r = [e, i], n = 2; n < o.length; n += 2)
    r.push(e, i, o[n], (i = ((o[n] - e) * t) / 2), (e = o[n]), -i);
  return r;
}
function Gi(o, t) {
  ...
  for (
    ...
    ((c = i),
      ...
      !(i === n && r === s) &&
        ...
        (i !== c || r !== _) &&
          a.push(D(T + b), D(S + w), D(i), D(r), D(v + b), D(P + w))));
  return (
    i !== n || r !== s || a.length < 4
      ? a.push(D(n), D(s), D(n), D(s))
      : (a.length -= 2),
    a.length === 2
      ? a.push(i, r, i, r, i, r)
...
function hs(o) {
  ...
  for (r = 0; r < e; r++) {
    for (
      s = o[r], t += "M" + D(s[0]) + "," + D(s[1]) + " C", i = s.length, n = 2;
      n < i;
      n++
    )
      t +=
 ...
 */ var At,
  ...
  ds = function (t) {
    ...
    for (
      ...
      ((wt = "msTransform"), (Hi = wt + "Origin"));
      e.parentNode && (e = e.parentNode);
    );
    if (((ie = window), (ui = new ze()), e)) {
      ((At = e),
        (Tr = e.documentElement),
        (gi = e.body),
        (Oe = At.createElementNS("http://www.w3.org/2000/svg", "g")),
        (Oe.style.transform = "none"));
  ...
  Qa = function () {
    return (
      ie.pageXOffset || At.scrollLeft || Tr.scrollLeft || gi.scrollLeft || 0
    );
  },
  wr = function (t) {
    return (
  ...
  ki = function o(t, e) {
    if (t.parentNode && (At || ds(t))) {
      var i = wr(t),
        ...
        l = At.createElementNS
          ? At.createElementNS(r.replace(/^https/, "http"), n)
          : At.createElement(n);
      return (
        e &&
          (i
      ...
      e ||
        ...
        i
          ...
          : t.style.removeProperty(
              wt.replace(/([A-Z])/g, "-$1").toLowerCase(),
            )),
      e || ui.clone()
    );
  },
  il = function (t, e) {
    ...
    if (t === ie) return t;
    if (
      (n.length || n.push(ki(t, 1), ki(t, 2), ki(t, 3)), (u = i ? Je : ke), i)
    )
      (r
      ...
      if (((c = _ = 0), _s))
        for (
          l = t.offsetParent, f = t;
          f && (f = f.parentNode) && f !== l && f.parentNode;
        )
          (ie.getComputedStyle(f)[wt] + "").length > 4 &&
            ((c = f.offsetLeft), (_ = f.offsetTop), (f = 0));
      if (
        ((d = ie.getComputedStyle(t)),
...
function _e(o, t, e, i) {
  if (!o || !o.parentNode || (At || ds(o)).documentElement === o)
    return new ze();
  var r = Ka(o),
    n = wr(o),
    s = n ? ps : gs,
 ...
 */ var rl = "x,translateX,left,marginLeft,xPercent".split(","),
  ...
  Te = function (t, e, i, r) {
    for (var n = e.length, s = r === 2 ? 0 : r, a = 0; a < n; a++)
      ((t[s] = parseFloat(e[a][i])), r === 2 && (t[s + 1] = 0), (s += 2));
    return t;
  },
  ue = function (t, e, i) {
  ...
  Gr = function (t, e, i, r, n, s, a, u, l) {
    if (a.type === "cubic") e = [e];
      ...
      (a.fromCurrent !== !1 && e.unshift(ue(i, r, u), n ? ue(i, n, l) : 0),
        a.relative && ys(e));
      var f = n ? Gi : Ha;
      e = [f(e, a.curviness)];
    }
    return (
      ...
      n && fi(t, i, n, e, "y", l),
      ee(e, a.resolution || (a.curviness === 0 ? 20 : 12))
    );
  },
  al = function (t) {
    return t;
  ...
  Hr = function (t, e, i) {
    ...
    return (
      ...
      e &&
        e !== "auto" &&
        ((n = e.push ? e[0] * (a ? a.width : t.offsetWidth || 0) : e.x),
        (s = e.push ? e[1] * (a ? a.height : t.offsetHeight || 0) : e.y)),
  ...
  Zi = function (t, e, i, r) {
    ...
    return (
      ...
      r === "auto" &&
        ...
        ((c = e.getAttribute("d").match(ll) || []),
        (c = s.apply({ x: +c[0], y: +c[1] })),
        (l += c.x),
        (f += c.y)),
    ...
    return !t || !t.length
      ...
      : (r &&
          (r === "self" || (d = Ki(r)[0] || e) === e
            ...
            : (u && u[2] !== !1
                ? yt.set(e, {
                    transformOrigin: u[0] * 100 + "% " + u[1] * 100 + "%",
                  })
                : (u = [ue(e, "xPercent") / -100, ue(e, "yPercent") / -100]),
              (p = Zi(e, d, u, "auto")),
              (h = p.apply({ x: l, y: f })),
              Pe(
                t,
        ...
        n
          ? Pe(t, n.a, n.b, n.c, n.d, n.e, n.f)
          : (s || a) && Pe(t, 1, 0, 0, 1, s || 0, a || 0),
        t);
  },
  ...
  vs = {
    ...
    register: function (t, e, i) {
      ((yt = t),
        (oe = yt.utils.getUnit),
        (Ki = yt.utils.toArray),
        (Ri = yt.core.getStyleSaver),
        (Wr = yt.core.reverting || function () {}),
        (ms = i));
    },
    init: function (t, e, i) {
      if (!yt)
      ...
      if (
        ...
        for (h in _)
          !f && ~rl.indexOf(h) ? (f = h) : !c && ~nl.indexOf(h) && (c = h);
        f && c
          ? r.push(
              Gr(
                this,
        ...
        for (h in _)
          h !== f &&
            h !== c &&
            r.push(Gr(this, Te([], s, h, 2), t, h, 0, d, e, oe(s[0][h])));
      } else
        ((p = d(xs(Qe(e.path), t, e))),
          ee(p, e.resolution),
          r.push(p),
          fi(this, t, e.x || "x", p, "x", e.unitX || "px"),
          fi(this, t, e.y || "y", p, "y", e.unitY || "px"));
    ...
    render: function (t, e) {
      ...
      if (e.tween._time || !Wr()) {
        for (t > 1 ? (t = 1) : t < 0 && (t = 0); r--;)
          qr(i[r], t, !r && e.rotate, i[r]);
        for (; n;) (n.set(n.t, n.p, n.path[n.pp] + n.u, n.d, t), (n = n._next));
        e.rotate &&
          e.rSet(
            e.target,
            e.rProp,
            i[0].angle * (e.radians ? sl : 1) + e.rOffset + e.ru,
            e,
            t,
          );
      } else e.styles.revert();
    ...
    arrayToRawPath: function (t, e) {
      ...
      return (
        e.relative && ys(i),
        [e.type === "cubic" ? i : Gi(i, e.curviness)]
      );
    },
  };
...
const fl = ({
    ...
    bird: t,
    bankRef: e,
    onCompleteAnimation: i,
    isPlayEggsAnimation: r,
    totalProductivity: n,
  }) => {
      ...
      B.useEffect(() => {
        ...
        switch (t.id) {
          case Pt.YELLOW:
            g = {
              duration:
                ((y = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : y.duration) || 2,
              rotation:
                ((x = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : x.rotation) || "+=800",
              motionPath: {
                path: [{ left: p.left + 100, top: p.top + 95 }, h],
                curviness: 2,
              },
              ease:
                ((T = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : T.ease) || "power2.in",
            };
            break;
          case Pt.GREEN:
            g = {
              duration:
                ((v = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : v.duration) || 3,
              rotation:
                ((b = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : b.rotation) || "+=800",
              motionPath: {
                path: [
              ...
              ease:
                ((S = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : S.ease) || "power3.in",
            };
            break;
          case Pt.BLUE:
            g = {
              duration:
                ((P = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : P.duration) || 2.5,
              rotation:
                ((w = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : w.rotation) || "-=800",
              motionPath: {
                path: [
              ...
              ease:
                ((M = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : M.ease) || "power2.in",
            };
            break;
          case Pt.RED:
            g = {
              duration:
                ((R = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : R.duration) || 4,
              rotation:
                ((O = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : O.rotation) || "-=1000",
              motionPath: {
                path: [
                  { left: p.left - 120, top: p.top + 60 },
                  { left: p.left - 140, top: p.top + 100 },
                  h,
                ],
                curviness: 0.5,
              },
              ease:
                ((C = t == null ? void 0 : t.animation) == null
                  ? void 0
                  : C.ease) || "power3.in",
            };
            break;
          case Pt.BABY: {
            ((p.top -= 15),
              (g = {
                duration:
                  ((I = t == null ? void 0 : t.animation) == null
                    ? void 0
                    : I.duration) || 3,
                rotation:
                  ((L = t == null ? void 0 : t.animation) == null
                    ? void 0
                    : L.rotation) || "-=600",
                motionPath: {
                  path: [
                ...
                ease:
                  ((A = t == null ? void 0 : t.animation) == null
                    ? void 0
                    : A.ease) || "power3.in",
              }));
            break;
      ...
      k.jsxs("div", {
        ...
        children: [
          k.jsxs("div", {
            ...
            children: [
              k.jsx(Bs, {}),
              k.jsx("p", { className: We.value, children: Ds(e) }),
            ],
          }),
          k.jsx(Oi, {
      ...
      B.useEffect(() => {
        ...
        const u = setInterval(() => {
          const l = Date.now(),
            f = i.map((c) =>
              l >= c.nextEggTime
                ? (o(c.bird, !0), { ...c, nextEggTime: l + c.intervalMs })
                : c,
            );
          (r(f),
  ...
  Tl = ({ startEggsAnimation: o, addEgg: t }) => {
    ...
    return (
      ...
      k.jsxs(sn.div, {
        ...
        children: [
          k.jsx("div", {
            className: qe.bottomBannerImage,
            children: k.jsx("img", { src: Ls, alt: "" }),
          }),
          i <= 500 &&
            i < vl &&
            !_ &&
            k.jsxs("p", {
              className: qe.infoTitle,
              children: [
                e("homepage.warehouseBanner"),
                Math.floor(d || 0),
                " ",
                e("homepage.time"),
              ],
          ...
          _ &&
            k.jsx("p", {
              className: qe.infoTitle,
              children: e("warehousePage.warehouseFullText"),
            }),
          k.jsx(yl, {}),
        ],
      })
  ...
  Ol = ({ isBankReady: o }) => {
    ...
    return (
      ...
      k.jsxs(k.Fragment, {
        children: [
          k.jsx("img", {
            className: Zr.bankImage,
            src: u,
            alt: "",
            ref: o ? f : null,
          }),
          k.jsx("img", { className: Zr.backImage, src: Sl, alt: "" }),
        ],
      })
    );
  },
              ...
              k.jsxs("div", {
                ...
                children: [
                  ...
                  k.jsxs("div", {
                    ...
                    children: [
                      k.jsx(Oi, {
                        text: k.jsxs(k.Fragment, {
                          children: [i("shop"), k.jsx(Ns, {})],
                        }),
                        onClick: () => {
                          (Yt(), o("/shop"));
                        },
                      ...
                      k.jsx(Oi, {
                        text: i("skip"),
                        onClick: r,
                        className: `button redButton ${we.claimButton}`,
                      }),
                    ],
                  }),
                ],
  ...
  Fl = B.lazy(() =>
    tr(
      () => import("./BirdsInfoModal.BYEshiHZ.js"),
      __vite__mapDeps([10, 1, 2, 3, 4, 5, 6, 11, 7, 8, 12]),
    ),
  ),
  $l = B.lazy(() =>
    tr(
      () => import("./AnimationModal.O4BI6i1K.js"),
      __vite__mapDeps([13, 1, 2, 3, 4, 5, 6, 7, 8, 14]),
    ),
  ),
  Yl = () => {
    const { open: o } = on(),
    ...
    return k.jsxs(k.Fragment, {
      children: [
        k.jsxs("button", {
          className: Jr.infoBirds,
          onClick: t,
          children: [k.jsx(br, {}), k.jsx("span", { children: k.jsx(Es, {}) })],
        }),
        k.jsxs("button", {
          className: Jr.animationButton,
          onClick: e,
          children: [
            k.jsx(br, {}),
            k.jsx("span", { children: k.jsx("img", { src: zl, alt: "" }) }),
          ],
        }),
      ],
    });
        ...
        k.jsxs(Qi, {
          ...
          children: [
            ...
            k.jsxs("div", {
              ...
              children: [
                k.jsx("img", { className: Ge.touch, src: ql, alt: "" }),
                k.jsx("p", { children: o("competitionPage.prize2") }),
                k.jsxs("p", { children: ["$", t] }),
              ],
            }),
          ],
    ...
    return k.jsx("div", {
      ...
      children: k.jsxs(Qi, {
        ...
        children: [
          ...
          k.jsxs("div", {
            className: Ci.cloudText,
            children: [
              k.jsx("p", { className: "time", children: js(r, o, !1, !1) }),
              k.jsx("p", { children: o("action.cloud.title") }),
            ],
          }),
        ],
      }),
